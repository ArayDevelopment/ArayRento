...
<head>
    <?php
    include "../../ArayRentoController/admin/SelectLocations.php";
    global $groupedLocations;
    ?>
    <meta charset="utf-8">
    <title>لیست منطقه ها</title>
    ...
    <div class="page__body--wrapper" id="dashbody__page--body__wrapper">
        ...
        <main class="main__content_wrapper">
            <div class="dashboard__container dashboard__reviews--container">
                <div class="reviews__heading mb-30"><h2 class="reviews__heading--title">لیست منطقه ها</h2>
                        ...
                        <div class="reviews__table table-responsive">
                            <table class="reviews__table--wrapper package_table_wrapper">
                                ...
                                foreach ($groupedLocations as $locations) {
                                    $name = $locations['name_rento_locations_aray'];
                                    $region = $locations['region_rento_locations_aray'];
                                    ?>
                                    <tr>
                                        <td><span class="package__table--body--text"><?php echo $name ?></span></td>
                                        <td><span class="package__table--body--text"><?php echo $region ?></span></td>
                                    </tr>
                                    <?php
                                }
                                ?>
