...
try {
    $stmt = $conn->prepare("SELECT * FROM aray_rento_advertisements_aray where `user_id_rento_advertisements_aray` = $userId");
    $stmt->execute();
    ...
    <div class="page__body--wrapper" id="dashbody__page--body__wrapper">
        ...
        <main class="main__content_wrapper">
            <div class="dashboard__container dashboard__reviews--container">
                <div class="reviews__heading mb-30"><h2 class="reviews__heading--title">آگهی های من</h2></div>
                                    ...
                                    <td>
                                        <div class="reviews__action--wrapper position-relative">
                                            ...
                                            <ul class="dropdown-menu sold-out__user--dropdown"
                                                ...
                                                <li><a data-bs-toggle="modal" href="edit-advertisements.php?id=<?= $advertisementId ?>">ویرایش کنید</a>
                                                </li>
