...
<?php
session_start();
include '../../ArayRentoController/admin/UpdateAdvertisements.php';
?>
<head>
    <meta charset="utf-8">
    <title>ویرایش
    ...
    <div class="page__body--wrapper" id="dashbody__page--body__wrapper">
        ...
        <main class="main__content_wrapper">
            <div class="dashboard__container add__property--container">
                <div class="add__property--heading mb-30"><h2 class="add__property--heading__title">ویرایش
                        آگهی</h2></div>
                <div class="add__property__inner d-flex">
                    <div class="add__property--step left">
                        <div class="add__property--step__inner">
                            <div class="add__property--box mb-30"><h3 class="add__property--box__title mb-20">ویرایش
