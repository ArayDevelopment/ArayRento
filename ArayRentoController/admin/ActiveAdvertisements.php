...
$stmt = $conn->prepare("UPDATE aray_rento_advertisements_aray SET status_rento_advertisements_aray=0 where id_rento_advertisements_aray=$advertisementId");
if($stmt->execute()){
    echo '
<html>
<head>
